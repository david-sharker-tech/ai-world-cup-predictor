...
export const AI_MODELS: AiModel[] = [
  { id: 'gpt',      name: 'GPT-5',             openrouter: 'openai/gpt-5',                colorHex: '#10a37f', logo: '/ai-logos/gpt.svg',      country: 'USA',   founder: 'Sam Altman'     },
  ...
  { id: 'gemini',   name: 'Gemini 2.5 Pro',    openrouter: 'google/gemini-2.5-pro',       colorHex: '#378ADD', logo: '/ai-logos/gemini.svg',   country: 'USA',   founder: 'Sundar Pichai'  },
  ...
  { id: 'kimi',     name: 'Kimi K2.6',         openrouter: 'moonshotai/kimi-k2.6',        colorHex: '#D4537E', logo: '/ai-logos/kimi.svg',     country: 'China', founder: '杨植麟'         },
];
