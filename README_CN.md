...
![比赛详情](docs/screenshots/match.zh.png)
...
| 文档 | 角色 |
|---|---|
| `README.md` | 英文版用户文档(GitHub 默认入口) |
| `README_CN.md`(本文件) | 中文版用户文档:启动 / 使用 / 项目结构 / 当前能力 |
...
> 📌 **维护提示**:`README.md`(英文)与 `README_CN.md`(中文)是同一份文档的两个语言版本,**任何更新都必须同步改两份**。
